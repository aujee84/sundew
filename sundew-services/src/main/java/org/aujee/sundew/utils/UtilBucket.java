package org.aujee.sundew.utils;
...
public final class UtilBucket {
    ...
    private static final Map<String, Class<?>> SUPPORTED_TYPE_MAPPER = HashMap.newHashMap(17);

    private UtilBucket() {}

    static {
        SUPPORTED_TYPE_MAPPER.put("String", String.class);
    ...
    //TODO - provide to user capability to use a delimiter in array type ('),
    //TODO - support for array of every primitive type, list, set, map
